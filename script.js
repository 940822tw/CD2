...
//// Workshop I : Manifesto poster ////
    if (num==-2){html+="<p><img src='src/main.png' id='main'><br><span style='color:blue'>디자이너 엄태욱(Te-euk, Real moomin)</span>은 홍익대학교 시각디자인과에서 디자인을 공부했다. 마이크로 타이포그라피, 특히 웹에 기반한 스크린-모바일 타이포그라피 작업을 주로 하며, 프리랜서 개발자-디자이너로 일하는 동안 패션, 그래픽 디자이너, 뮤지션들과 협업했다."
    ...
    if (num==-1){
      ...
      html+="<div class='calendar2'>w4<br>10.03<br><br><br><br></div>"
    ...
    if (num==2){
      ...
      html+="<img src='src/2-7.jpg'><br><p>책의 재료에는 재생지를 사용했고, 각 페이지마다 간단한 퍼즐로 주제와 관련된 비주얼을 만들었다. 총 5개 챕터로 구성되었기 때문에 5종의 퍼즐을 넣었고, 각 도비라에는 우화나 단상을 넣어 주제에 대해 미처 풀지못한 이야기를 싣었다. 디자인 결과물은 <u><a onclick="+"'addContent(3)'"+"'>Output</a></u>에서 확인할 수 있다.</p>"
